...
interface PaymentInfoInterface {
	...
	class PaymentInfo extends Message implements PaymentInfoInterface {
		...
		public function setCreditorSchemeIdentification($creditorSchemaId) {
			...
			$this->CreditorSchemeIdentification = $this->removeSpaces($creditorSchemaId);
			return $this;
		}
		 ...
		 * @return $this
		 */
		public function setUltimateCreditorId($id) {
		 ...
		 * @return string
		 */
		public function getUltimateCreditorId() {

			return $this->ultimateCreditorId;
		}
		/**
		 * Identifies whether a single entry per individual transaction or a batch entry for the sum of the amounts of
		...
		public function getSimpleXMLElementPaymentInfo() {
			...
			if ( !empty($this->getUltimateCreditor()) ) {

				$UltmtCdtr = $paymentInfo->addChild('UltmtCdtr');
				$UltmtCdtr->addChild('Nm',$this->getUltimateCreditor());
				if(!empty($this->getUltimateCreditorId())){
					$UltmtCdtr->addChild('Id')->addChild('OrgId')->addChild('Othr')->addChild('Id',$this->getUltimateCreditorId());
				}
			}
